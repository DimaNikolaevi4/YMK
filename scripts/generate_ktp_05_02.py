...
# ============================================================
# ОИ1 (Нестеренко) — для монтажных тем: 2.2, 2.3, 2.4
# ОИ2 (Сидорова) — для безопасности (2.1) и ремонта (2.5–2.8)
...
#
# Столбец 8 (equipment):
#   теория -> BOOK_OI1 (темы 2.2-2.4 монтаж) или BOOK_OI2 (тема 2.1, 2.5-2.8 ремонт)
...
TOPICS = [
    ...
    # ========= Тема 2.4 (4ч: 2 теория + 2 практика) — СЕМ.4 =========
    {
        ...
        "lessons": [
            {"name": "Тема 2.4 Монтаж защитного заземления и зануления",
             "hours": 2, "is_practice": False, "is_lab": False, "practice_prep": 0,
             "equipment": BOOK_OI1, "task": "Стр. 124-167", "note": "Вх.контр"},
    ...
    # ========= Тема 2.7 (10ч: 6 теория + 4 практика) — СЕМ.4 =========
    {
        ...
        "lessons": [
            ...
            {"name": "Тема 2.7 Ремонт воздушных и кабельных линий электропередачи (часть 1)",
             "hours": 2, "is_practice": False, "is_lab": False, "practice_prep": 0,
             "equipment": BOOK_OI2, "task": "Стр. 285-296", "note": "Вх.контр"},
            {"name": "Тема 2.7 Ремонт воздушных и кабельных линий электропередачи (часть 2)",
             "hours": 2, "is_practice": False, "is_lab": False, "practice_prep": 0,
             "equipment": BOOK_OI2, "task": "Стр. 297-308", "note": "Текущий контроль"},
            {"name": "Тема 2.7 Ремонт воздушных и кабельных линий электропередачи (часть 3)",
             "hours": 2, "is_practice": False, "is_lab": False, "practice_prep": 0,
             "equipment": BOOK_OI2, "task": "Стр. 309-320", "note": "Текущий контроль"},
            # Практика (4ч = 2 занятия)
    ...
    # ========= Тема 2.8 (22ч: 6 теория + 16 практика) — СЕМ.4 =========
    {
        ...
        "lessons": [
            ...
            {"name": "Тема 2.8 Ремонт электрических машин и трансформаторов (часть 3)",
             "hours": 2, "is_practice": False, "is_lab": False, "practice_prep": 0,
             "equipment": BOOK_OI2, "task": "Стр. 263-284", "note": "Текущий контроль"},
...
# ============================================================
SOURCES_BASIC = [
    {"code": "ОИ 1", "name": "Технология электромонтажных работ: учеб. пособие для СПО",
     "author": "Нестеренко В.М.", "publisher": "М.: ИЦ \"Академия\", 2022"},
    {"code": "ОИ 2", "name": "Сборка, монтаж, регулировка и ремонт узлов и механизмов оборудования, агрегатов, машин, станков и другого электрооборудования промышленных организаций: учебник",
     "author": "Сидорова Л.Г.", "publisher": "М.: ИЦ \"Академия\", 2022"},
    {"code": "ОИ 3", "name": "Проверка и наладка электрооборудования: учебник",
     "author": "Ярочкина Г.В.", "publisher": "М.: ИЦ \"Академия\", 2022"},
    {"code": "ОИ 4", "name": "Монтаж, наладка, эксплуатация и ремонт систем электроснабжения промышленных предприятий: учебное пособие для СПО",
...
SOURCES_ADDITIONAL = [
    ...
    {"code": "ДИ 6", "name": "Общая технология электромонтажных работ: учебник для СПО",
     "author": "Григорьева С.В.", "publisher": "М.: ИЦ \"Академия\", 2020"},
    {"code": "ДИ 7", "name": "Организация и выполнение работ по монтажу и наладке электрооборудования промышленных и гражданских зданий. В двух частях. Часть 1. Внутреннее электроснабжение промышленных и гражданских зданий: учебник",
     "author": "Бычков А.В.", "publisher": "М.: ИЦ \"Академия\", 2020"},
    {"code": "ДИ 8", "name": "Организация и выполнение работ по монтажу и наладке электрооборудования промышленных и гражданских зданий. В двух частях. Часть 2. Монтаж и наладка электрооборудования промышленных и гражданских зданий: учебник",
