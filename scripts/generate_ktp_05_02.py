...
- Столбец 8 (Мат.обеспечение): для теории — один основной источник (ОИ1),
  для практики — кабинет/лаборатория (№3, 2а)
- Столбец 9 (Задания): для теории — страницы из ОИ1, согласованные с темой;
...
# ============================================================
# ОСНОВНОЙ ИСТОЧНИК (одна явная книга для столбца 8)
# ============================================================
# Для теории используется один учебник — ОИ1.
# Полные данные книги в Таблице 2б.
MAIN_BOOK_CODE = "ОИ1"
...
#
# Столбец 8 (equipment):
#   теория -> MAIN_BOOK_CODE (ОИ1 — один основной учебник)
#   практика -> PRACTICE_EQUIP (№3, 2а — кабинет/лаборатория)
#
# Столбец 9 (task):
#   теория -> страницы из ОИ1, согласованные с темой занятия
...
TOPICS = [
    ...
    # ========= Тема 2.4 (4ч: 2 теория + 2 практика) — СЕМ.4 =========
    {
        ...
        "lessons": [
            {"name": "Тема 2.4 Монтаж защитного заземления и зануления",
             "hours": 2, "is_practice": False, "is_lab": False, "practice_prep": 0,
             "equipment": MAIN_BOOK_CODE, "task": "Стр. 113-120", "note": "Вх.контр"},
    ...
    # ========= Тема 2.5 (16ч: 8 теория + 8 практика) — СЕМ.4 =========
    {
        ...
        "lessons": [
            ...
            {"name": "Тема 2.5 Монтаж электрических машин и силовых трансформаторов (часть 1)",
             "hours": 2, "is_practice": False, "is_lab": False, "practice_prep": 0,
             "equipment": MAIN_BOOK_CODE, "task": "Стр. 121-130", "note": "Вх.контр"},
            {"name": "Тема 2.5 Монтаж электрических машин и силовых трансформаторов (часть 2)",
             "hours": 2, "is_practice": False, "is_lab": False, "practice_prep": 0,
             "equipment": MAIN_BOOK_CODE, "task": "Стр. 131-140", "note": "Текущий контроль"},
            {"name": "Тема 2.5 Монтаж электрических машин и силовых трансформаторов (часть 3)",
             "hours": 2, "is_practice": False, "is_lab": False, "practice_prep": 0,
             "equipment": MAIN_BOOK_CODE, "task": "Стр. 141-150", "note": "Текущий контроль"},
            {"name": "Тема 2.5 Монтаж электрических машин и силовых трансформаторов (часть 4)",
             "hours": 2, "is_practice": False, "is_lab": False, "practice_prep": 0,
             "equipment": MAIN_BOOK_CODE, "task": "Стр. 151-160", "note": "Текущий контроль"},
    ...
    # ========= Тема 2.7 (10ч: 6 теория + 4 практика) — СЕМ.4 =========
    {
        ...
        "lessons": [
            ...
            {"name": "Тема 2.7 Ремонт воздушных и кабельных линий электропередачи (часть 1)",
             "hours": 2, "is_practice": False, "is_lab": False, "practice_prep": 0,
             "equipment": MAIN_BOOK_CODE, "task": "Стр. 191-200", "note": "Вх.контр"},
            {"name": "Тема 2.7 Ремонт воздушных и кабельных линий электропередачи (часть 2)",
             "hours": 2, "is_practice": False, "is_lab": False, "practice_prep": 0,
             "equipment": MAIN_BOOK_CODE, "task": "Стр. 201-210", "note": "Текущий контроль"},
            {"name": "Тема 2.7 Ремонт воздушных и кабельных линий электропередачи (часть 3)",
             "hours": 2, "is_practice": False, "is_lab": False, "practice_prep": 0,
             "equipment": MAIN_BOOK_CODE, "task": "Стр. 211-220", "note": "Текущий контроль"},
            # Практика (4ч = 2 занятия)
    ...
    # ========= Тема 2.8 (22ч: 6 теория + 16 практика) — СЕМ.4 =========
    {
        ...
        "lessons": [
            ...
            {"name": "Тема 2.8 Ремонт электрических машин и трансформаторов (часть 1)",
             "hours": 2, "is_practice": False, "is_lab": False, "practice_prep": 0,
             "equipment": MAIN_BOOK_CODE, "task": "Стр. 221-230", "note": "Вх.контр"},
            {"name": "Тема 2.8 Ремонт электрических машин и трансформаторов (часть 2)",
             "hours": 2, "is_practice": False, "is_lab": False, "practice_prep": 0,
             "equipment": MAIN_BOOK_CODE, "task": "Стр. 231-240", "note": "Текущий контроль"},
            {"name": "Тема 2.8 Ремонт электрических машин и трансформаторов (часть 3)",
             "hours": 2, "is_practice": False, "is_lab": False, "practice_prep": 0,
             "equipment": MAIN_BOOK_CODE, "task": "Стр. 241-250", "note": "Текущий контроль"},
